...
?>
    ...
    <div class="page_title" data-stellar-background-ratio="0" data-stellar-vertical-offset="0" ><!--<style="background-image:url(http://placehold.it/1599x640);">-->
      <ul>
        <li><a href="javascript:;">Ticket booking</a></li>
      </ul>
    </div>
    <!--page title end-->
                              ...
                              <div class="col-lg-8 col-md-8">
                                <div class="review_content">
                                  <div class="top_head_bar">
                                    <h4>ROUTE</h4>
                                    <span class="country_span">kolhapur to pune</span> <span class="country_span"> One Way </span> </div>
                        ...
                        <div class="inludes_section flight_schedule_section"> <span class="emirates_button btn-yellow">emirates</span>
                          <div class="main_section_flight">
                            <div class="country_section_box">
                              ...
                              <h4>kolhapur</h4>
                              <p class="shedule_d">20 Sep 2019</p>
                            </div>
                            <div class="middle_flight_section">
                              <h5>Total Time</h5>
                              <p><!-- <i class="fa fa-clock-o"></i> --> 4 hours, 30 Minutes</p>
                            </div>
                            <div class="country_section_box">
                      ...
                      <div class="tab_inner_body full_width">
                        ...
                        <div class="inludes_section flight_schedule_section"> <span class="emirates_button btn-yellow">emirates</span>
                          <div class="main_section_flight">
                            ...
                            <div class="country_section_box">
                              <h4>pune</h4>
                              <p class="shedule_d">22 Sep 2019</p>
                            </div>
                          </div>
                        </div>
                        <!-- tab include area End --> 
