...
<head>
<meta charset="utf-8" />
<title>Tours and Travels Online bus Booking</title>
      ...
      <div class="container">
        <div class="row">	
          <div class="col-md-6 col-sm-6">
            <p><i class="fa fa-phone"></i>contact no:  <span>+91 8959462585</span></p>
          </div>
          <div class="col-md-6 col-sm-6">
            <div class="top_menu">
              <ul>
               <!-- <li><a href=""><i class="fa fa-globe"></i> Languages</a>
                ...
                <li><a href="">My Account</a></li>
				  ...
				  <li class="Travelite_cancel_alert"><a href="#">cancel</a></li>
              </ul>
            </div>
          </div>
        </div>
            ...
            <div class="main_menu">
              <ul>
                <li class="active"><a href="home.php">home</a></li>
                 <li><a href="allbus.php">All Bus</a></li>
